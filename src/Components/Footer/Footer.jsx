...
//     <p>Copyright © 2023 - Bangla Foods</p>
//   </div> 
...
<footer className="footer footer-center p-10 bg-green-50   text-black">
  <div>
    <LazyLoad>

  <img src="https://www.svgrepo.com/show/1191/cooking.svg" className='w-[55px]' alt="" />
    </LazyLoad>
    <p className="font-bold">
      Bangla Food <br/>Providing Food Recipe since 1992
    </p> 
